...
$themeData['page_header_title'] = Lang('stock_alert_label');
$themeData['page_breadcrumb'] .= '<li><span>' . Lang('stock_alert_label') . '</span></li>';
$themeData['page_header'] = \iCms\UI::view('backend/header/page_header');
$themeData['site_title'] .= ' - ' . Lang('stock_alert_label');
$themeData['footer_jquery_bc'] = '<script type="text/javascript">$("#stkalrt_sp").addClass( "active" );</script>';
$themeData['page_modals'] = '';
if (@$seller['system'] || @$seller['moderator']) {
    $themeData['page_content'] = \iCms\UI::view('backend/seller/stock_alert/content');
    ...
    <script src="' . $config['theme_url'] . '/backend/jquery/seller/stock_alert/view.js"></script>';
}