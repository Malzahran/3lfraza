...
$themeData['page_breadcrumb'] .= '<li><span>' . Lang('delivery_agent_label') . '</span></li>';
...
$("#delv_sp").addClass( "active" );
</script>';
$themeData['page_modals'] = null;
if (@$seller['system'] || @$seller['moderator']) {
    $themeData['page_content'] = \iCms\UI::view('backend/delivery/content');
    ...
    $themeData['footer_jquery_p'] .= '<script src="' . $config['theme_url'] . '/backend/jquery/delivery/view.js"></script>';
    $themeData['footer_scripts_p'] .= '
    <script src="' . $config['theme_url'] . '/backend/vendor/jquery-validation/jquery.validate.min.js"></script>';
    $themeData['page_modals'] .= \iCms\UI::view('backend/delivery/add-modal');
