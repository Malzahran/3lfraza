...
function bannerSlider() {
    ...
    bannerSlider.on("translated.owl.carousel", function (a) {
        ...
        0 != c && setTimeout(function () {
            setTimeout(function () {
                b.children("h1").css("top", 100).animate({opacity: 1}, {
                    duration: 400,
                    queue: !1
                }).animate({top: 0}, {duration: 600, easing: "easeOutExpo"})
            }, 0), setTimeout(function () {
                b.children(".description").css("top", 100).animate({opacity: 1}, {
                    duration: 400,
                    queue: !1
                }).animate({top: 0}, {duration: 600, easing: "easeOutExpo"})
            }, 100), setTimeout(function () {
                b.children(".btn").css("top", 100).animate({opacity: 1}, {
                    duration: 400,
                    queue: !1
                }).animate({top: 0}, {duration: 600, easing: "easeOutExpo"})
            }, 200)
        ...
        bannerSlider.find(".owl-item:not( .active )").find(".banner-center-box > *").animate({opacity: 0}, 150).css("top", 1)
    }), bannerSlider.on("changed.owl.carousel", function (a) {
        bannerSlider.find(".banner-center-box > *").animate({opacity: 0}, 150).css("top", 1)
    }), bannerSlider.on("resized.owl.carousel", function (a) {
        bannerSlider.find(".banner-center-box > *").animate({opacity: 1}, 150)
    });
}
...
function portfolioIsotope() {
    ...
    var x = 0;
    $(".loadmore-pi").click(function (a) {
        a.preventDefault();
        var b = $(this).text(), c = $(this).data("text-loading"), d = $(this).data("text-loading-finished"),
            e = c ? c : "Loading!", f = d ? d : "No More!", g = $(".portfolio-items").data("pi-load-file"),
            h = g ? g : "loadmore-portfolio-items.html";
        $(this).addClass("loading").find("span").text(e), $.ajax({
            type: "GET", url: h, success: function (a) {
                $(".portfolio-items").waitForImages({
                    finished: function () {
                        console.log(".portfolio-items background image loaded"), setTimeout(function () {
                            $(".loadmore-pi").removeClass("loading").find("span").text(b)
                        }, 2500), setTimeout(function () {
                            var c, b = $(a).find(".portfolio-item").length;
                            $body.hasClass("device-lg") ? c = 4 : $body.hasClass("device-md") ? c = 3 : $body.hasClass("device-sm") || $body.hasClass("device-xs") ? c = 2 : $body.hasClass("device-xxs") && (c = 1);
                            var d = x + c,
                                e = $(a).find(".portfolio-item").slice(x, d).addClass("loaded").appendTo(".portfolio-items");
                            if (x = x + c <= b ? x + c : b, imageBG(), portfolioSingleExpander(), lightboxGallery(), $portfolioIsotope.isotope("appended", e), x >= b) return $(".loadmore-pi").removeClass("colorful").addClass("dark animated shake").text(f), !1
                        }, 3e3)
                    }, waitForAll: !0
                })
            }
...
function portfolioSingleExpander() {
    (function () {
        $(".portfolio-item .portfolio-single-link").on("click", function () {
            $("#portfolio-single-content").removeClass("opened");
            var c, a = $(window).scrollTop() + 90, b = parseInt($(".portfolio-top").offset().top, 10);
            a !== b ? ($("html, body").animate({scrollTop: $(".portfolio-top").offset().top - 90}, {
                easing: "easeInOutExpo",
                duration: 1e3
            }), c = 1200) : c = 0;
            var d = $(this).find(".open-portfolio-single").attr("href") + " .portfolio-single-load";
            setTimeout(function () {
                $("#portfolio-single-wrap").addClass("opened").animate({height: 95}, 0, function () {
                    setTimeout(function () {
                        $(".portfolio-single-loader").addClass("opened"), setTimeout(function () {
                            $("#portfolio-single-content").load(d, function (a) {
                                $("#portfolio-single-content").waitForImages({
                                    finished: function () {
                                        $("#portfolio-single-wrap").removeClass("opened"), $(".portfolio-single-loader").removeClass("opened"), portfolioSingleSlider(), sliderImageBG(), optimizeSliderImageBG(), dataCustomOptions(), setTimeout(function () {
                                            $("#portfolio-single-wrap, #portfolio-single-content").height($(".portfolio-single-load").outerHeight()), $("#portfolio-single-content").addClass("opened")
                                        }, 500)
                                    }, waitForAll: !0
                                })
                            })
        ...
        }), $(document).on("click", ".project-close", function (a) {
            return $("#portfolio-single-content").removeClass("opened"), $("#portfolio-single-wrap").removeClass("opened"), setTimeout(function () {
                $("#portfolio-single-wrap").height(0)
            }, 500), setTimeout(function () {
                $(".portfolio-single-load").remove()
            }, 500), setTimeout(function () {
                $("html, body").animate({scrollTop: $(".portfolio-top").offset().top - 90}, 600)
            }, 1200), !1
        });
    })();
}
...
function cfSuccess() {
    var successMsgData = $(".cf-notifications").data("success-msg"),
        successMsgDefault = "Thank you for your submission :)",
        successMsg = successMsgData ? successMsgData : successMsgDefault;
    $("#contact-form")[0].reset();
    var successContent = '<i class="cf-success-icon fa fa-check"></i>' + successMsg;
    cfSubmitMSG(!0, successContent), $(".cf-notifications-cont").addClass("sent"), $(".cf-notifications").css("opacity", 0), $(".cf-notifications").slideDown(300).animate({opacity: 1}, 300).delay(5e3).slideUp(400);
}
...
function cfSubmitMSG(valid, msg) {
    var msgClasses;
    msgClasses = valid ? "shake animated" : "bounce animated", $(".cf-notifications").delay(300).addClass(msgClasses).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
        $(this).removeClass("shake bounce animated")
    }), $(".cf-notifications").children(".cf-notifications-cont").html(msg);
}
