...
if (isset($itemInfo['id'])) {
    ...
    $item['desc'] .= !empty($itemInfo['qualification']) ? '<br><b><font color="#4db849">' . Lang('qualification_label') . ':</font></b> ' . $itemInfo['qualification'] : '';
    ...
    if (!empty($itemInfo['phone'])) {
        $item['contact_title'] = Lang('contact_worker_label');
