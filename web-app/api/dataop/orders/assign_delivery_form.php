...
if (isset($itemInfo['order_id'])) {
    $formlayout = array('formhead' => Lang('assign_delv_label') . ' - ' . Lang('order_number_label') . ' ' . $itemInfo['order_id'],
        'formbutton' => Lang('assign_delv_label'));
    $id = 0;
    $form = array();
    $spindata = array();
    ...
    } else $spindata[] = array('id' => 0, 'name' => Lang('req_order_sell_delv_label'));
    $form[] = array(
        'id' => $id += 1,
        'place' => 1,
        'icon' => 15,
        ...
        'required' => 1,
        'name' => 'delv_id',
        'title' => Lang('req_order_sell_delv_label'),
        'spinner' => $spindata);
    $form[] = array(
        'id' => $id += 1,
        'type' => 8,
