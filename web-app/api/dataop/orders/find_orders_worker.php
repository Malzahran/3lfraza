                ...
                if (!empty($ordItems)) {
                    foreach ($ordItems as $ke => $va) {
                        ...
                        if (isset($ordItem['id'])) {
                            ...
                            $desc .= !empty($ordItemInfo['notes']) ? '<br><font color="red">' . Lang('preparation_notes_label') . ': ' . $ordItemInfo['notes'] . '</font>' : '';
                            $desc .= '</b></span>';
                        }
                    }
                }
