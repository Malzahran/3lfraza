...
public class ActivityWorker extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_login:
                ...
                login.putExtra("type", "worker");
                startActivity(login);
                break;
            case R.id.btn_register:
                IntentData registerIntent = new IntentData(6, 0, 0, 0, 0, "register_forms", "add_worker_form", null, "add_worker");
